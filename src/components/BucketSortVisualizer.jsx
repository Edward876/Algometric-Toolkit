...
// Styled components - unique color theme for bucket sort (blue/purple gradient)
...
const Title = styled.h1`
  ...
  line-height: 1.2;
  padding: 0.5rem;
  text-shadow: 0 0 30px rgba(71, 118, 230, 0.3);
  letter-spacing: -1px;
  ...
  &::before {
    ...
    right: 0;
    bottom: -10px;
    background: radial-gradient(ellipse at center, rgba(71, 118, 230, 0.15) 0%, rgba(0, 0, 0, 0) 70%);
    z-index: -1;
    border-radius: 50%;
  }
`;
...
const Button = styled(motion.button)`
  background: ${props => props.primary ? 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' : '#334155'};
  border: none;
...
const ArrayBar = styled(motion.div)`
  ...
  background: ${props => {
    if (props.distributing) return '#8B5CF6';
    if (props.sorting) return '#7C3AED';
    if (props.gathering) return '#6366F1';
  ...
  align-items: flex-end;
  padding-bottom: 4px;
  color: ${props => props.value * 2 < 50 ? '#fff' : '#1e293b'};
  font-weight: bold;
  font-size: 0.8rem;
  position: relative;
  box-shadow: ${props => (props.distributing || props.sorting || props.gathering) ? '0 0 15px rgba(139, 92, 246, 0.5)' : 'none'};
...
const Bucket = styled(motion.div)`
  ...
  border: 1px dashed ${props => props.active ? '#8B5CF6' : 'rgba(255, 255, 255, 0.2)'};
  border-radius: 8px;
  margin-bottom: 1.5rem;
  box-shadow: ${props => props.active ? '0 0 15px rgba(139, 92, 246, 0.3)' : 'none'};
`;
...
const StepCard = styled(motion.div)`
  background: ${props => props.active ? 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' : 'rgba(51, 65, 85, 0.8)'};
  ...
  cursor: pointer;
  box-shadow: ${props => props.active ? '0 10px 20px rgba(71, 118, 230, 0.2)' : 'none'};
  border: 1px solid ${props => props.active ? 'rgba(71, 118, 230, 0.5)' : 'rgba(255, 255, 255, 0.05)'};
`;
...
const Tab = styled.button`
  background: ${props => props.active ? 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' : 'transparent'};
  color: ${props => props.active ? 'white' : '#94a3b8'};
  border: none;
  padding: 1rem 1.5rem;
  cursor: pointer;
  ...
  &:hover {
    ...
    background: ${props => props.active ? 'linear-gradient(90deg, #4776E6 0%, #8E54E9 100%)' : 'rgba(51, 65, 85, 0.3)'};
  }
`;
